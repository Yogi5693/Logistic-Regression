getwd()
setwd("C:/Users/Home/Desktop/capston")
shadata<-read.csv("sampletelecomfinal.csv", stringsAsFactors = T)
library(dplyr)
...
76dat5$N<-unclass(shaddata1%>%mutate(dec=ntile(change_mou,n=10))%>%count(dec)%>%unname())[[2]]
