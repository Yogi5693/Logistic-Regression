...
##################### Logistic Regression ###############################################
# Aim = The Director marketer wants to Build model based on certain attributes who is good customer and who is bad customer
#Customer spends more then avg amount then customer considerd as good customer
# Customer spends less then avg amount then customer considerd as Bad custome
